...
import com.tracking.taskservice.dto.response.AlternativeResponse;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<AlternativeResponse> handleTaskServiceException(TaskServiceException exception) {
